<?php
      ...
      if (isset($_SESSION['user_data'])) {
       ...
       $sql = "SELECT * FROM instructor WHERE firstname ='$firstname'";
...
<nav class="w3-sidebar w3-text-white w3-collapsew3-animate-left" style="background-color:#1c526a; z-index:3;width:250px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <button   class="w3-bar-item w3-button  w3-round tablink" onclick="openDiv(event, 'registration')"><i class="fa fa-plus fa-fw"></i>Course Selection</button>
...
<?php endif ?>
  ...
  <div class="w3-panel">
    <div class="w3-row-padding" style="margin:0 -16px">
      <div id="registration" class="w3-container yashii" >
		<h5 class="w3-center">Course Selection</h5>
    <div class="w3-center">
      <?php
        echo "Welcome <b>".$_SESSION['user_data']['firstname']. "</b> you need to select course first";
     ?>
     </div>

          <form id="regForm" class="w3-card w3-light-grey" action="select_course_post.php" method="post">
  <h1>Register:</h1>
  ...
  <!-- <div class="tab">Demographic Info:
   ...
   <div class="tab">Contact Info:
    ...
    <p><input type="text"  placeholder="Physical Address" oninput="this.className = ''" name="address"></p>
  </div> 
  <div class="tab">Course Details:
    <p><input type="text"  placeholder="TRN" oninput="this.className = ''" name="TRN"></p>
    <p><select class="form-control" name ="course_name">
