      ...
      <span> 
       ...
       <button  class="w3-bar-item w3-button w3-small" onclick="openDiv(event, 'messages')">
        <?php 
          ...
          // if (empty($message_count)>0) {
          //   echo '<i class="fa fa-envelope"></i><sup class="w3-badge w3-green">'.$message_count.'</sup>';
          // }
          // else{
          //   echo '<i class="fa fa-envelope"></i><sup class="w3-badge w3-green">0</sup>';
          // }
        ?>
 ...
 <div class="w3-panel">
    <div class="w3-row-padding" style="margin:0 -16px">
          <div id="all_users" class="w3-container yashii">
               <button onclick="document.getElementById('add_user').style.display='block'" class="w3-button  w3-blue w3-small w3-round"><i class="fa fa-plus fa-fw"></i>Add User</button>
                 ...
                 <?php
                       ...
                       while ($row = mysqli_fetch_array($result)) { ?>
                          <tr>
                            ...
                            <td colspan="2">
                              <button name="edit_user" class="w3-button w3-small w3-round w3-green" onclick="document.getElementById('edit_user').style.display='block'" href="home.php?edit_user=<?php echo $id;?>" ><i class="fa fa-pencil fa-fw"></i></button>
                            
                              <a href="php/remove_content.php?remove_user=<?php echo $row1['id']?>" name="remove_user" class="w3-button w3-small w3-round w3-red"><i class="fa fa-trash-o fa-fw"></i></a>
                            </td>
                          </tr>
                        <?php } ?>
                 ...
                 <?php
                       ...
                       while ($row = mysqli_fetch_array($result)) { ?>
                          <tr>
                            ...
                            <td colspan="2">    
                              <a name="edit_payment" class="w3-button w3-small w3-round w3-green" onclick="document.getElementById('edit_payment').style.display='block'" href="#edit_user?edit_payment=<?php echo $row1['id'];?>" ><i class="fa fa-pencil fa-fw"></i></a>                        
  ...
  <div id="student" class="w3-container yashii" style="display:none">
    <h5>Student</h5>
        ...
        <tr class="w3-text-white" style="background-color:   #032331;">
              ...
              <?php
                           $conn = mysqli_connect("localhost","root","","yashii");
                             $sql = "SELECT students.id, students.firstname, students.lname, students.gender, students.age, students.email, students.mobile, students.email, students.course_name, students.TRN, students.nyumba, users.username, users.email FROM students INNER JOIN users ON students.email = users.email";
                           $result = $conn->query($sql);
                       while ($row = mysqli_fetch_array($result)) { ?>
                          <tr>
                            <td><?php echo $row['firstname']; ?></td>
  ...
  <div id="instructor" class="w3-container yashii" style="display:none">
    <h5>Instructor</h5>
        ...
        <tr class="w3-text-white" style="background-color:   #032331;">
              ...
              <?php
                           $conn = mysqli_connect("localhost","root","","yashii");
                           $sql = "SELECT instructor.id, instructor.firstname, instructor.lastname, instructor.email, instructor.mobile, instructor.course_name, instructor.address, users.username, users.email FROM instructor INNER JOIN users ON instructor.email = users.email";
                           $result = $conn->query($sql);
                       while ($row = mysqli_fetch_array($result)) { ?>
                          <tr>
                            <td><?php echo $row['firstname']; ?></td>
    ...
    <div class="w3-modal-content w3-card-4 w3-animate-zoom  w3-light-gray" style="max-width:600px">
      ...
      <form class="w3-container" action="php/add_schedule.php" method="post">
        <div class="w3-section">
          ...
          <input class="w3-input w3-border w3-margin-bottom" type="time" placeholder="Start time" name="nyengo" required>
          <label><b>End Time</b></label>
          <input class="w3-input w3-border" type="time" placeholder="End time" name="nyengo1" required>
...
<div id="edit_user" class="w3-container yashii" style="display:none">
        ...
        <form class="w3-container w3-card-4 w3-light-grey  w3-margin" action="php/edit_content.php" method="post">
        <div class="w3-section">
          <div class="w3-container w3-center w3-block w3-text-white">
           ...
           <input class="w3-input w3-border w3-margin-bottom" type="text" value="<?php echo $record['id'];?>" name="id" hidden>
          <label><b>First Name</b></label>
          <input class="w3-input w3-border w3-margin-bottom" type="text" value="<?php echo $record['firstname'];?>" name="firstname" required>
          <label><b>Last Name</b></label>
          <input class="w3-input w3-border w3-margin-bottom" type="text" value="<?php echo $record['lastname'];?>" name="lastname" required>
          <label><b>Username</b></label>
          <input class="w3-input w3-border w3-margin-bottom" type="text" value="<?php echo $record['username'];?>" name="username" required>
        
          <label><b>Email</b></label>
          <input class="w3-input w3-border" type="email" value="<?php echo $record['email'];?>" name="email" required>         
           <label><b>Role</b></label>
          <input class="w3-input w3-border" type="text" value="<?php echo $record['role']?>" name="role" required>
          <br>
  ...
  <div id="insert_new" class="w3-modal">
    <div class="w3-modal-content w3-card-4 w3-animate-zoom  w3-light-gray" style="max-width:600px">
      ...
      <form class="w3-container" action="php/add_new_record.php" >
        <div class="w3-section">
          <h3 class="w3-center">New Road Traffic Record</h3>

          <label><b>Road Traffic Number</b></label>
          <input class="w3-input w3-border w3-margin-bottom" type="text" name="TRN" placeholder="Enter your TRN" required>
            <label><b>First Name</b></label>
          ...
          <label><b>Course Name</b></label>
          <input class="w3-input w3-border w3-margin-bottom" type="text" name="course_name" placeholder="Enter course name" required>
          ...
          <button class="w3-button  w3-green w3-small" name="insert_new" type="submit" >Add</button>
          <button onclick="document.getElementById('road_traffic').style.display='block'" type="reset" class="w3-button w3-red w3-right">Cancel</button>
        </div>
      </form>      
